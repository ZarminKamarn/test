const homeTemplate = `<template>
  <img src="./banner.webp" alt="main_banner" class="main_banner" />
  <section class="property2">
    <img src="./cards_img/plane.png" alt="image_of_plane" width="310" height="338" />
  ...
  <section class="property5">
    ...
    <div class="testimonial">
      <img src="./cards_img/Rectangle 29.png" alt="img-of-natalie-portman" />
      <div>
        <p>
    ...
    <div class="testimonial left">
      ...
      <img src="./cards_img/Rectangle 31.png" alt="img-of-Andy-murray" />
    </div>
  </section>
