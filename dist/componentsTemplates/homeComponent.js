const homeTemplate = `<template>
  <img src="/test/public/banner.webp" alt="main_banner" class="main_banner" />
  <section class="property2">
    <img src="/test/public/cards_img/plane.png" alt="image_of_plane" width="310" height="338" />
  ...
  <section class="property3">
    ...
    <div>
      <div class="arg">
        ...
        <img
          src="/test/public/cards_img/Frame 41.png"
          alt="frame-41"
          width="266.5"
          height="322.4"
          class="arg-image"
      ...
      <div class="arg">
        ...
        <img
          src="/test/public/cards_img/Frame 43.png"
          alt="frame-43"
          width="266.5"
          height="322.4"
          class="arg-image"
      ...
      <div class="arg">
        ...
        <img
          src="/test/public/cards_img/Frame 44.png"
          alt="frame-44"
          width="266.5"
          height="322.4"
          class="arg-image"
  ...
  <section class="property4">
    ...
    <div>
      <div class="deal">
        ...
        <img
          src="/test/public/cards_img/Group 22.png"
          alt="group-22"
          width="381"
          height="282"
          class="deals-img"
      ...
      <div class="deal">
        ...
        <img
          src="/test/public/cards_img/Group 20.png"
          alt="group-22"
          width="381"
          height="282"
          class="deals-img"
      ...
      <div class="deal">
        ...
        <img
          src="/test/public/cards_img/Group 24.png"
          alt="group-24"
          width="381"
          height="282"
          class="deals-img"
  ...
  <section class="property5">
    ...
    <div class="testimonial">
      <img src="/test/public/cards_img/Rectangle 29.png" alt="img-of-natalie-portman" />
      <div>
        <p>
    ...
    <div class="testimonial left">
      ...
      <img src="/test/public/cards_img/Rectangle 31.png" alt="img-of-Andy-murray" />
    </div>
  </section>
